...
//En horizontal 0 es lado izquierdo, 90 de frente y 180 lado derecho.
//En vertical 90 es horizontal y 180 echado hacia adelante
...
void setup() {
  ...
  // llevo el servo a posición inicial
  servoX.write(90);
  servoY.write(90);  
  delay(1000);
